...
@Generated(
    ...
    date = "2023-08-10T03:53:42+0200",
    comments = "version: 1.5.5.Final, compiler: javac, environment: Java 17.0.7 (Oracle Corporation)"
)
public class ReportMapperImpl implements ReportMapper {

    @Override
    public void updateNameReportDTOFromMun(ForecastDTO forecastDTO, Municipality mun) {
        if ( mun == null ) {
            return;
        }
    ...
    @Override
    public ForecastDTO dayToReportDTO(DayData dayData) {
        if ( dayData == null ) {
            return null;
        }
